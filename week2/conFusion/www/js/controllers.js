angular.module('conFusion.controllers', [])
    ...
    .controller('FavoritesController', ['$scope', 'menuFactory', 'favoriteFactory', 'baseURL', 
                                        '$ionicListDelegate', '$ionicPopup', '$ionicLoading', '$timeout', function(
                                        $scope, menuFactory, favoriteFactory, baseURL, $ionicListDelegate, $ionicPopup, 
...
// implement the IndexController and About Controller here
    ...
    .controller('AboutController', ['$scope', 'baseURL', 'corporateFactory', 'aboutFactory', 
                                    function($scope, baseURL, corporateFactory, aboutFactory) {
        $scope.baseURL = baseURL;
